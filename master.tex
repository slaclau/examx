...
\ProvidesFile{master.tex}[2022/02/01 v1.0 This is the master 
...
\begin{document}
	...
	\UseDateOf{master.tex}. This document 
	corresponds to \file{examx.dtx}~\UseVersionOf{examx.dtx}, dated 
	\UseDateOf{examx.dtx} and 
	\file{styles.dtx}~\UseVersionOf{styles.dtx}, dated 
	\UseDateOf{styles.dtx}.}}
